...
function pick(options, weights = Array(options.length).fill(1)) {
...
class Rect {
    ...
    randomPoint(bounds) {
        let point = [this.corners[0][0], this.corners[0][1]];
...
export default function randomPlacementsDomino(numStone, { size, margins, handicap, preventAdjacent = undefined, separation = 0 }) {
